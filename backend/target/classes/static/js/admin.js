(function () {
  ...
  tabs.forEach(function (tabId, i) {
    document.getElementById(tabId).addEventListener('click', function (e) {
      ...
      if (tabId === "tab-filters") loadFilters();      if (tabId === 'tab-subscriptions') loadAdminSubscriptions();
  ...
  var modals = ['modal-filter'];
  modals.forEach(function (modalId) {
    var modal = document.getElementById(modalId);
    if (!modal) return;
    modal.querySelector('.modal-backdrop').addEventListener('click', function () { hide(modal); });
    modal.querySelector('.modal-close').addEventListener('click', function () { hide(modal); });
  });
